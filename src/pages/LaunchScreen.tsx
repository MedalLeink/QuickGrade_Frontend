...
const LaunchScreen: React.FC = () => {
  ...
  return (
    <>
      <div
        className="relative bg-cover bg-center min-h-screen flex flex-col items-center justify-between w-screen h-screen"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                src={logo}
                alt="Logo"
                style={{ width: "32px", height: "32px", borderRadius: "40%" }}
              />
            </div>
            <h1
              style={{
          ...
          <div className="w-96 h-56 mt-7 mx-auto p-8 border rounded-md bg-white">
            <label htmlFor="sign-in" className="block mb-2 text-gray-600">
              Sign in As:
            </label>
