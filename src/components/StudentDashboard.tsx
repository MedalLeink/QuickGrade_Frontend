    ...
    <div className='pl-[100px] '>
        ...
        <div className=' w-[1000px] mt-[90px] ml-[120px]'>
            ...
            <div className='w-[173px] h-[45px] leading-[44.8px]'>
                <p className='font-inter font-bold text-lg font-[700] '>
                    Dashboard
                </p>
            </div>
            {/* The Lecturer */}
                    ...
                    <div className=''>
                        ...
                        <div>
                            <table className=''>
                                <thead>
                                <tr>
                                     <th className="pl-[25px] pr-[55px] whitespace-nowrap">Course Code</th>
                                ...
                                <tbody className=''>
                                     ...
                                     <tr className="border-4 border-gray-400">
                                            ...
                                            <td className="p-[5px] whitespace-nowrap">Chemical Engineering</td>
                                            <td className="pl-[35px] p-[15px]">10 Aug 2023/<br/> 2:10PM</td>
                                            <td className="p-[15px]">Campus E-centre</td>
                                            <td className="pl-[90px]">211</td>
                                            <td className="pl-[45px]">
                                                <button className='border border-purple-50 text-purple-50 px-2 py-2 rounded-full hover:bg-purple-50 hover:text-white transition-all duration-300'>Set Exam</button>
                                            </td>
                                     </tr>
