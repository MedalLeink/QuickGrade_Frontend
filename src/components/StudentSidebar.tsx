        ...
        <div className="w-[20%] h-screen bg-[#2D00F7] top-0 left-0 fixed p-[20px] flex justify-center" style={{zIndex: '200'}}>
            <div className="w-[250px] pt-4">
                <div className="flex w-full justify-around">
                    ...
                    <div className="text-white text-[32px] font-sans font-xxl">QuickGrade</div>
                </div>
                ...
                <NavLink to="/StudentDashboard" className="p-[10px] flex gap-2 jusify-center items-center rounded-lg" style={({ isActive }) => { return { backgroundColor: isActive ? "white" : "#2D00F7", color: isActive ? "blue" : "white"};}}>
                ...
                <NavLink to="/EnrolledCourses" className="p-[10px] flex gap-2 jusify-center items-center rounded-lg" style={({ isActive }) => { return { backgroundColor: isActive ? "white" : "#2D00F7", color: isActive ? "blue" : "white"};}}>
                ...
                <div className="mt-[20px]">
                <NavLink to='/you' className="p-[10px] flex gap-2 jusify-center items-center rounded-lg" style={({ isActive }) => { return { backgroundColor: isActive ? "white" : "#2D00F7", color: isActive ? "blue" : "white"};}}>
                        <span className="py-2"><GiStairs className="p-0.5 rounded text-white bg-[#8265F7]"/></span>
                ...
                <div className="mt-[20px]">
                <NavLink to='/us' className="p-[10px] flex gap-2 jusify-center items-center rounded-lg" style={({ isActive }) => { return { backgroundColor: isActive ? "white" : "#2D00F7", color: isActive ? "blue" : "white"};}}>
                        <span className="py-2"><IoIosSettings className="p-0.5 rounded text-white bg-[#8265F7]"/></span>
